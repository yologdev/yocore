...
- **Memories & skills** — Browse extracted memories, decisions, and reusable skills per project
...
| Memory extraction | No — requires [Yo Memory](yo-memory.md) |
| Project context & knowledge base | No — requires [Yo Memory](yo-memory.md) |
| Hybrid semantic search | No — requires [Yo Memory](yo-memory.md) |

## Next Step

Want your AI assistant to learn from past sessions? Enable the [Yo Memory](yo-memory.md) layer to add AI-powered memory extraction, ranking, and semantic search.
